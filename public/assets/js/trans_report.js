$(document).ready(function() {
    ...
    function handleRefund(transactionId) {
        ...
        const refundBtn = $('#transactionrefundBtn');
    ...
    $(document).on('click', '#transactionrefundBtn', function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed && result.value) {
                Swal.fire({
                    ...
                    $('.transactionrefundBtn[data-id="' + requestId + '"]').prop('disabled', true);
...
// Update resolveTransaction to return the promise
function resolveTransaction(requestId) {
    return $.ajax({
        url: '/transaction/' + requestId + '/resolve',
        type: 'POST',
        data: {
