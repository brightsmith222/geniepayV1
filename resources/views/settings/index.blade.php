            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="text-input-container">
                        ...
                        <button class="btn-toggle-visibility" data-target="current-password">
                ...
                <div class="form-group">
                    ...
                    <div class="text-input-container">
                        ...
                        <button class="btn-toggle-visibility" data-target="new-password">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="text-input-container">
                        ...
                        <button class="btn-toggle-visibility" data-target="confirm-password">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                </div>
