...
<div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Reported Transaction</h5>
                         <!-- Search Input -->
                                  ...
                                  <div class="search-container">
                                    <form>
                                        <input type="text" 
                                               ...
                                               data-route="{{ route('reported.index') }}" 
                                               data-table="#reported-table" 
                                               data-pagination=".reported-pagination">
                        ...
                        <div class="table-responsive">
                            <table class="table" id="reported-transaction-table">
                                ...
                                <tbody>
                                    @if($reportedTransactions->isEmpty())
                                      <tr>
                                          <td colspan="15" class="text-center">No data available</td>
                                          </tr>
                                      @else

                                        @foreach($reportedTransactions as $transaction)
                                        ...
                                        <td><span class="status {{ strtolower($transaction->status) === 'reported' ? 'pending #ffe390' : 'cancel #dc3545' }}">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            {{ $reportedTransactions->links() }}
                        </div>
                        <!-- Transaction Details Modal -->
    @foreach($reportedTransactions as $transaction)
<div class="modal fade" id="reportedtransactionModal" tabindex="-1" aria-labelledby="reportedtransactionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <p><strong>Invoice:</strong> <span id="reportedmodalInvoice"></span></p>
                        <p><strong>Status:</strong> <span id="reportedmodalStatus"></span></p>
                        <p><strong>Username:</strong> <span id="reportedmodalUsername"></span></p>
                        <p><strong>Service:</strong> <span id="reportedmodalService"></span></p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>Amount:</strong> <span id="reportedmodalAmount"></span></p>
                        <p><strong>Balance Before:</strong> <span id="reportedmodalBalanceBefore"></span></p>
                        <p><strong>Balance After:</strong> <span id="reportedmodalBalanceAfter"></span></p>
