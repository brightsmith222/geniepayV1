...
<body>
    ...
    <div style="max-width: 550px; background-color: #ffffff; border-radius: 8px; margin: 0 auto; overflow: hidden; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <div style="padding: 20px; text-align: center;">
            <h1 style="font-size: 22px; color: #333333;">Recover Password</h1>
            <p style="font-size: 16px; font-weight: bold;">Thanks for using <span style="color: #008744;">GeniePay <span></p>
            <p style="font-size: 16px; font-weight: bold;">Please enter the verification code below to enable you recover your password:</p>
